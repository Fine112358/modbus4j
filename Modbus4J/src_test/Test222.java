...
public class Test222 {
	 ...
	 * @return 结果
	 */
	public static ByteQueue modbusRTCP(String ip, int port, int salveId,int start, int readLenth,ModbusMaster tcpMaster) {
	...
	public static void main(String[] args) throws InterruptedException {
		ModbusMaster tcpMaster = getTcpMaster("10.0.3.243", 502, 1);// 得到tcpMaster
		while(true){
			ByteQueue result = Test222.modbusRTCP("10.0.3.243", 502, 1,0, 3,tcpMaster);
			Thread.sleep(1000L);
			ansisByteQueue(result);
		}
//		short[] shor = new short[1];
//		shor[0] = 0x33;
//		Test222.modbusWTCP("10.0.3.243", 502, 1, 0, shor);
